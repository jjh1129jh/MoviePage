        ...
        <footer className="h-45 md:h-34 flex flex-col">
            ...
            <div className="w-full h-[40%] bg-gray-900 md:bg-[#1d1d1d] md:flex md:items-center md:justify-center">
                <div className="w-full h-full flex items-center md:items-start justify-end md:justify-center gap-3 md:gap-5 pr-3 md:pr-0">
                    <div className="flex items-center"><img className="w-5" src="/img/svg_html.svg" alt="html" />
                    <span className="hidden">Html</span>
                    </div>
                    <div className="flex items-center"><img className="w-5" src="/img/svg_css.svg" alt="Css" />
                    <span className="hidden">Css</span>
                    </div>
                    <div className="flex items-center"><img className="w-5" src="/img/svg_tailwind.svg" alt="Tailwind" />
                    <span className="hidden">Tailwind</span>
                    </div>
                    <div className="flex items-center"><img className="w-5" src="/img/svg_js.svg" alt="Js" />
                    <span className="hidden">Js</span>
                    </div>
                    <div className="flex items-center"><img className="w-5" src="/img/svg_react.svg" alt="React" />
                    <span className="hidden">React</span>
                    </div>
                    <div className="flex items-center"><img className="w-5 invert-90" src="/img/svg_next.svg" alt="Next" />
